...
class GraphMainFragment : Fragment() {
    ...
    private var url: String = "http://192.168.1.34:8081/graph"
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_graph_main, container, false)

        WebView.setWebContentsDebuggingEnabled(true);

        val webView: WebView = view!!.findViewById<WebView>(R.id.graph_web_view)
