...
class StudyMainFragment : Fragment() {
    ...
    private var url: String = "http://192.168.1.34:8081/study"
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_study_main, container, false)

        WebView.setWebContentsDebuggingEnabled(true);

        val webView: WebView = view!!.findViewById<WebView>(R.id.study_web_view)
