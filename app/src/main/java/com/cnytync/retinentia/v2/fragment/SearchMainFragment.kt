...
class SearchMainFragment : Fragment() {
    ...
    private var url: String = "http://192.168.1.34:8081/search"
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_search_main, container, false)

        WebView.setWebContentsDebuggingEnabled(true);

        val webView: WebView = view!!.findViewById<WebView>(R.id.search_web_view)
